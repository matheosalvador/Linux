...
je veux créer un compte utilisateur SQL autorisé à se connecter uniquement depuis la machine hébergeant le site web pour permettre l'accès distant à la base de données "utilisateurs".
