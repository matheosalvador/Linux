...
>En tant qu'analyste, 
je veux installer l'outil htop et configurer un alias (par exemple vers la commande tail -f /var/log/apache2/access.log) 
afin de surveiller les ressources du serveur en temps réel.
