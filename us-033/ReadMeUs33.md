...
je veux installer l'extension php-mysql permettant d'utiliser PDO sur le serveur hébergeant Apache 
afin d'utiliser PHP pour accéder à une base de données
